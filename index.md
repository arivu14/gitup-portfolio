...
<div class="page-wrap" id="main-site">
    ...
    <nav class="tab-nav">
        ...
        <button class="tab-btn" onclick="openTab(event, 'roadmap')">3. THREAT INTEL ROADMAP</button>
    </nav>
...
<div id="detection" class="tab-content active">
            <div class="mission-summary">
                CASE-001: SSH BRUTE FORCE DETECTION & RESPONSE [WAZUH SIEM]
            </div>
...
<div class="card" style="margin-bottom: 30px; border-left: 5px solid #10b981; background: rgba(16, 185, 129, 0.05);">
                ...
                <p style="font-family: sans-serif; color:#cbd5e1; font-size: 0.9rem; line-height:1.6;">
                    Built on Google Colab using <b>Gemini 2.5-Flash</b>. This agent automates the "Pivot" phase of an investigation. It takes raw Wazuh JSON data, queries threat intelligence APIs, and outputs a human-readable verdict to reduce MTTR (Mean Time To Respond).
                </p>
            </div>
...
VERDICT: BENIGN. Asset identified as internal management server. No further action required.</div>
                </div>
            </div>
        </div>

  <div id="roadmap" class="tab-content">
            <div class="mission-summary">PROFESSIONAL DEVELOPMENT PIPELINE</div>
            <div class="roadmap-item">
                <span class="status-done">✔</span>
                <div><b>Wazuh SIEM Integration:</b> Real-time alerting for SSH attacks.</div>
            </div>
<div class="roadmap-item">
                <span class="status-done">✔</span>
                <div><b>AI Triage Automation:</b> Custom Python Agent using Gemini API.</div>
            </div>
  <div class="roadmap-item">
                <span class="status-pending">⚡</span>
                <div><b>AbuseIPDB Auto-Lookup:</b> In-progress API automation for IP reputation.</div>
            </div>
 <div class="roadmap-item">
                <span class="status-pending">⚡</span>
                <div><b>Maltbook Visualization:</b> Converting Agent reports into link-analysis graphs.</div>
            </div>
        </div>
